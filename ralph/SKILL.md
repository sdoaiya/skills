...
- Select agent tiers before first delegation using the inline tier rules below: LOW for simple lookups, STANDARD for normal implementation and review, THOROUGH for complex debugging, security, architecture, or large multi-file changes.
