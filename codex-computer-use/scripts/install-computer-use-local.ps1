...
This local compatibility plugin is installed by a Codex Windows Computer Use repair workflow. It supplies the Windows helper transport paths that Codex Desktop resolves for Computer Use.
...
function Sync-OpenAiBundledPluginCache {
  ...
  Copy-DirectoryContentByStream $sourcePluginRoot $cacheVersionRoot
...
function Sync-BundledMarketplaceFromInstalledApp {
  ...
  Copy-DirectoryContentByStream $sourceRoot $MarketplaceRoot
}
