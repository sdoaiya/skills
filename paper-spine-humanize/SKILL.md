...
Read the language-specific tier guide for the complete directives:
`references/humanize-tiers-zh.md` for Chinese output or
`references/humanize-tiers-en.md` for English output.
